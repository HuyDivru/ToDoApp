...
public interface Contants {
    ...
    String INTENT_EXTRA_EDIT_TASK_DETAIL_POSITION="INTENT_EXTRA_EDIT_TASK_DETAIL_POSITION";
    ...
    String DATABASE_FILE_PATH_FOLDER="ToDoApp";
    String DATABASE_FILE_PATH_FILE_NAME="data.realm";
    String DATABASE_FILE_BACKUP_PATH_FOLDER="ToDoApp/Backup";
    String DATABASE_FILE_EXPORT_PATH_FOLDER="ToDoApp/Export";

    long AUTO_NOTIFY_TIME=1000*60*60;

    int AUTO_NOTIFY_NOTIFICATIOIN_ID=0;
